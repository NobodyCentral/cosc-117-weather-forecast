...
def calc_aqi_level(concentration, intervals) -> int: # changed output from type str to int
    for interval_level, interval_max in intervals:
        if float(concentration) <= interval_max: # Cast concentration to float for comparison
